...
export const zh = {
  ...
  browserEmbedAnyway: '尝试直接加载（通常仍会被浏览器阻止）',
  browserRememberChoice: '记住对此域名的选择',
  browserRememberedExternal: '{host} 已记住在浏览器中打开',
  browserOpenNow: '立即打开',
  browserChangeChoice: '更改',
  browserForcedBanner: '该站点拒绝嵌入，按你的选择尝试直接加载（通常显示空白阻止页）',
  subagent: '任务管理',
  openSubagent: '任务管理',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  browserEmbedAnyway: 'Try loading directly (usually still blocked by the browser)',
  browserRememberChoice: 'Remember choice for this domain',
  browserRememberedExternal: '{host} is remembered to open in the browser',
  browserOpenNow: 'Open now',
  browserChangeChoice: 'Change',
  browserForcedBanner: 'This site refuses embedding; loading directly per your choice (usually a blank block page)',
  subagent: 'Tasks',
  openSubagent: 'Tasks',
